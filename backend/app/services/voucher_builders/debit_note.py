...
def build_debit_note_xml(row: dict, company_name: str) -> str:
    """Build Tally XML for a Debit Note voucher."""
    date = row.get("date", "")
    ...
    etree.SubElement(voucher, "VOUCHERTYPENAME").text = "Debit Note"
    ...
    etree.SubElement(e1, "LEDGERNAME").text = party
    ...
    etree.SubElement(e2, "LEDGERNAME").text = "Purchase Account"
